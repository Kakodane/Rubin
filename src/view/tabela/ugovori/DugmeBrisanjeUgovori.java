...
public class DugmeBrisanjeUgovori extends AbstractCellEditor implements TableCellRenderer, TableCellEditor, MouseListener   {
	/**
	 * 
	 */
	private static final long serialVersionUID = 5416011138697776915L;
	private JTable tabela;
	private JButton prikazDugme;
	private JButton akcijaDugme;
	private boolean isEditorActive = false;
	
	public DugmeBrisanjeUgovori(JTable tabela, int kolona) {
		this.tabela = tabela;
